    ...
    class AcaoEntrada implements ActionListener{
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if(res == 2){
                ...
                if(view.getTxNome().length() < 3){
                    JOptionPane.showMessageDialog(null, "ERRO: Campo NOME muito curto. Minimo de 3 letras.");
                    res = 3;
                }
                ...
                if(view.getTxtCPF().length() != 11){
                    JOptionPane.showMessageDialog(null, "ERRO: Campo CPF precisa de 11 digitos");
                    res = 3;
                }
            
                if(view.getTxTel().length() != 9){
                    JOptionPane.showMessageDialog(null, "ERRO: Campo TELEFONE precisa de 9 digitos");
                    res = 3;
                }
                if(res == 2){
                    ...
                    if(res != 0){
                        ...
                        JOptionPane.showMessageDialog(null, "ERRO: Carro com esta PLACA ja está estacionado");
                    }
                }
            }
        }
